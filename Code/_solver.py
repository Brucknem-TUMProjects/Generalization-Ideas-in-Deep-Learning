...
class Solver(object):
    ...
    def _reset(self):
        ...
        self.epoch = 0
        self.best_val_acc = math.inf if self.is_regression else 0 # since for regression we want to minimi<e
        self.best_params = {}
        self.loss_history = []
    ...
    def train(self):
        ...
        for t in range(num_iterations):
            ...
            if first_it or last_it or epoch_end:
                ...
                if self.verbose:
                    if self.is_regression: # Here we print losses to the console
                ...
                self.update_accuracy(val_acc, self.is_regression)
